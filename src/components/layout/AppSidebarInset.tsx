...
export function AppSidebarInset({ children }: AppSidebarInsetProps) {
  ...
  return (
    <div className="flex-1 flex flex-col min-w-0">
      <header className="sticky top-0 z-10 flex h-16 shrink-0 items-center gap-2 border-b border-border px-6 bg-background">
      ...
      <div className="flex flex-1 flex-col gap-4 p-6 overflow-y-auto bg-background min-h-[calc(100vh-64px)]">
        {children}
      </div>
    </div>
  );
